...
class StyleForm(forms.ModelForm):
	...
	name = forms.CharField(max_length=32, help_text="Name", required=True, widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Long Skirt'}))
	...
	pattern = forms.CharField(max_length=32, help_text="Pattern", required=True, widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Flower Skirt or Plain Trouser'}))
	...
	class Meta:
		model = Style
		fields = ('name', 'sex', 'cost', 'pattern', 'description', 'style_img')